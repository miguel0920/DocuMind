...
public class DocumentsController(IMediator mediator) : ControllerBase
{
    ...
    public async Task<IActionResult> AskDocument([FromBody] AskRequest request, CancellationToken cancellationToken)
    {
        ...
        // Creamos el Query CQRS pasando la pregunta del usuario
        ...
        // Enviamos el Query a través de MediatR
        string response = await _mediator.Send(query, cancellationToken);
